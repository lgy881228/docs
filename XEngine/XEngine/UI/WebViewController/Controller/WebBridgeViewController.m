...
//        [configuration setURLSchemeHandler:[custom] forURLScheme:@"customScheme"];
...
- (BOOL)loadData
{
    ...
    {
        return [self loadHTMLStringWithBaseURL:self.baseUrl];
    }
    else
    {
        // do nothing
...
- (BOOL)loadHTMLStringWithBaseURL:(NSURL *)baseUrl
{
